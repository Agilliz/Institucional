...
const Footer = () => {
    ...
    return (
        ...
        <div className="mainFooter">
          <div
            className="sessaoFooterCima"
            style={{ borderBottom: "solid white" }}
          >
            <div className="containerFooter">
              <img
                src={logoCoelhinhoDireita}
                style={{ width: "30%" }}
                alt=""
              />
              <div
              ...
              >
                <span> Conectando destinos, entregando excêlencia. </span>
                <span>Sua parceria confiável em soluções lógicas</span>
              </div>
            </div>
            <div className="containerFooter">
              <div
            ...
            <div className="containerFooter">
              <h1 style={{marginBottom: "15%"}}>Mídias Sociais</h1>
              <div
                style={{
                  display: "flex",
                  width: "100%",
          ...
          <div className="sessaoFooterBaixo">
            <img src={logoNomeFooter} alt="" />
          </div>
        </div>
      </footer>
    );
